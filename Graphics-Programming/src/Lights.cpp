...
Lights::Lights(DirectionalLight directionalLight) : directionalLight(directionalLight) {}
...
void Lights::addShader(Shader* shader){
...
void Lights::setDirectionalLight(DirectionalLight newDirectionalLight){
...
void Lights::updateShaderDirectional(Shader* shader){
    shader->setVec3("directionalLight.direction", directionalLight.direction);
    shader->setVec3("directionalLight.phong.ambientStrenght", directionalLight.phong.ambient);
    shader->setVec3("directionalLight.phong.diffuseStrenght", directionalLight.phong.diffuse);
    shader->setVec3("directionalLight.phong.specularStrenght", directionalLight.phong.specular);
}
...
void Lights::updateShaderPoint(Shader* shader, PointLight light){
    ...
    shader->setVec3(("pointLights[" + std::to_string(light.index) + "].phong.ambientStrenght").c_str(), light.phong.ambient);
    shader->setVec3(("pointLights[" + std::to_string(light.index) + "].phong.diffuseStrenght").c_str(), light.phong.diffuse);
    shader->setVec3(("pointLights[" + std::to_string(light.index) + "].phong.specularStrenght").c_str(), light.phong.specular);
    shader->setFloat(("pointLights[" + std::to_string(light.index) + "].constant").c_str(), light.constant);
    shader->setFloat(("pointLights[" + std::to_string(light.index) + "].linear").c_str(), light.linear);
    shader->setFloat(("pointLights[" + std::to_string(light.index) + "].quadratic").c_str(), light.quadratic);
}
