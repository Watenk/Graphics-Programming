...
PlayerController::PlayerController(InputHandler* &input, Watenk::Time* &watenkTime, float speed, float mouseSensitivity) : watenkTime(watenkTime), speed(speed), mouseSensitivity(mouseSensitivity){
