...
const std::string TEXTUREPATH = "res/textures/smile.png";
...
public:
    ...
    */
    Texture2D(const std::string& texturePath = TEXTUREPATH, const int wrappingMode = WRAPPINGMODE, const int minimizeFilterMode = MINIMIZEFILTERMODE, const int magnifyFilterMode = MAGNIFYFILTERMODE);
    ~Texture2D();
